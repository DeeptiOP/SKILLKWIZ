    ...
    <>
      ...
      <section className="relative w-full bg-[#00418d] text-white relative overflow-hidden pt-24">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
          ...
          <p className="text-center max-w-3xl mx-auto text-base mb-8">
      ...
      <section className="w-full bg-white py-8">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-6 auto-rows-min">
          <div className="group bg-white overflow-hidden hover:bg-[#00418d] transition-all duration-500 p-6 rounded-lg shadow-lg flex flex-col items-center text-center h-[250px] hover:h-[350px]">
            ...
            <p className="opacity-0 group-hover:opacity-100 group-hover:mt-4 transition-opacity duration-500 text-base text-[#272727] group-hover:text-white text-center">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="w-full md:w-1/2">
              <h2 className="text-4xl md:text-5xl font-bold text-[#00418d] mb-6">
                Who We Are ?
              </h2>
              ...
              <p className="text-base text-[#272727] mb-4 italic">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="w-full md:w-1/3">
              <div className="relative">
                ...
                <div className="bg-[#f73e5d] text-white text-center py-3 font-bold text-2xl">
                  CEO
                </div>
              </div>
            </div>
